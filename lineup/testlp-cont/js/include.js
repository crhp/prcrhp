...
// pc表示
document.write('<p class="conv pc"><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'plan_pc_contents_negotiation\');" target="_blank">詳しくはお店のスタッフに聞いてみよう！</a></p>');
// sp表示
document.write('<p class="conv sp"><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'plan_sp_contents_negotiation\');" target="_blank">詳しくはお店のスタッフまで！</a></p>');
}
...
// メニューが4個以下の場合
	...
	<li><a href="http://toyota-dealers.jp/38102/support/catalog__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'endmenu_pc_contents_catalog\');" target="_blank"><span>カタログ請求</span></a></li>\
	<li><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'endmenu_pc_contents_negotiation\');" target="_blank"><span>商談予約</span></a></li>\
	</ul>\
	');
	...
	<li><a href="http://toyota-dealers.jp/38102/support/catalog__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'endmenu_sp_contents_catalog\');" target="_blank"><span>カタログ請求</span></a></li>\
	<li><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'endmenu_sp_contents_negotiation\');" target="_blank"><span>商談予約</span></a></li>\
	</ul>\
	');
...
function footermenu(){
	...
	<li><a href="http://toyota-dealers.jp/38102/support/catalog__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'footernavi_pc_navi_catalog\');" target="_blank">カタログ請求</a></li>\
	<li><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'footernavi_pc_navi_negotiation\');" target="_blank">商談予約</a></li>\
	</ul>\
	');
	...
	<li><a href="http://toyota-dealers.jp/38102/support/catalog__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'footernavi_sp_navi_catalog\');" target="_blank">カタログ請求</a></li>\
	<li><a href="http://toyota-dealers.jp/38102/support/shodan__all.html" onclick="ga(\'send\', \'event\', \'C-HR\', \'footernavi_sp_navi_negotiation\');" target="_blank">商談予約</a></li>\
	</ul>\
	');
}
