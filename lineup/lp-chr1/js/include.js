...
// pc表示
document.write('<p class="viewsite pc"><a href="#shop" ><span>今すぐお店で<br>見てみよう！</span></a></p>');
// sp表示
document.write('<p class="viewsite sp"><a href="#shop" ><span>今すぐお店で<br>見てみよう！</span></a></p>');
}
...
// pc表示
document.write('<p class="conv pc"><a href="#shop">実際に近くのカローラ愛媛で乗ってみる</a></p>');
// sp表示
document.write('<p class="conv sp"><a href="#shop">実際に近くのカローラ愛媛で乗ってみる</a></p>');
}
...
// pc表示
document.write('<p class="conv pc"><a href="#shop">詳しくはお店のスタッフに聞いてみよう！</a></p>');
// sp表示
document.write('<p class="conv sp"><a href="#shop">詳しくはお店のスタッフまで！</a></p>');
}
...
// メニューが4個以下の場合
	...
	document.write('\
	<ul class="pc">\
	<li><a href="http://toyota.jp/service/dealer/spt/trial-list-store?OFFICE_CD=37301&STORE_CD_TCOM=&CN=C&sel_car=" target="_blank"><span>試乗予約</span></a></li>\
	<li><a href="#shop"><span>店舗一覧</span></a></li>\
	<li><a href="http://toyota-dealers.jp/37301/support/catalog__all.html" );" target="_blank"><span>カタログ請求</span></a></li>\
	<li><a href="http://toyota.jp/service/dealer_estimate/dc/top?SALE_OFFICE_CD=37301" ;" target="_blank"><span>オンライン<br>見積もり</span></a></li>\
	</ul>\
	');
...
function footermenu(){
	...
	document.write('\
	<ul class="pc">\
	<li><a href="http://toyota.jp/service/dealer/spt/trial-list-store?OFFICE_CD=37301&STORE_CD_TCOM=&CN=C&sel_car=" target="_blank">試乗予約</a></li>\
	<li><a href="#shop">店舗一覧</a></li>\
	<li><a href="http://toyota-dealers.jp/37301/support/catalog__all.html" target="_blank">カタログ請求</a></li>\
	<li class="online"><a href="http://toyota.jp/service/dealer_estimate/dc/top?SALE_OFFICE_CD=37301" target="_blank">オンライン<br class="sp">見積もり</a></li>\
	</ul>\
	');
