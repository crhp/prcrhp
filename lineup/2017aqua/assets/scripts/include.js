...
//価格L
function l_price(){document.write('車両本体価格<span class="price">1,785,240円</span>');}

//価格S
function s_price(){document.write('車両本体価格<span class="price">1,886,760円</span>');}

//価格G
function g_price(){document.write('車両本体価格<span class="price">2,062,800円</span>');}

//価格Gソフトレザーセレクション
function g2_price(){document.write('車両本体価格<span class="price">2,089,800円</span>');}

//価格Crossover
function co_price(){document.write('車両本体価格<span class="price">2,062,800円</span>');}
