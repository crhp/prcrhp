...
$(document).ready(function () {
	load_data("json/common.json");
	load_data2("json/gradetemplate.json");
});
	...
	if (campaign_check == true) {
		...
		switch(item_number){
			...
			case "1":
				...
				$("#itemcell > div:nth-child(1) img").attr("src","img/p_campaign01.png");
				$("div#itemcell.single_item").children("div:nth-child(n+2)").css("display","none");
				break;
			case "2":
				$("div#itemcell").addClass("double_item");
				$("#itemcell > div:nth-child(1) img").attr("src","img/p_campaign01.png");
				$("#itemcell > div:nth-child(2) img").attr("src","img/p_campaign02.png");
			...
			case "3":
				...
				$("#itemcell > div:nth-child(1) img").attr("src","img/p_campaign01.png");
				$("#itemcell > div:nth-child(2) img").attr("src","img/p_campaign02.png");
				$("#itemcell > div:nth-child(3) img").attr("src","img/p_campaign03.png");
			...
			case "4":
				...
				$("#itemcell > div:nth-child(4) img").attr("src","img/p_campaign04.png");
