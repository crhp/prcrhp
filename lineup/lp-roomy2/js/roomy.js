...
$(function(){
	$("#mov1").on("inview",function(){
		var t=$("#mov1").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov2").on("inview",function(){
		var t=$("#mov2").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov3").on("inview",function(){
		var t=$("#mov3").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov4").on("inview",function(){
		var t=$("#mov4").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov5").on("inview",function(){
		var t=$("#mov5").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov6").on("inview",function(){
		var t=$("#mov6").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov7").on("inview",function(){
		var t=$("#mov7").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov8").on("inview",function(){
		var t=$("#mov8").get(0);setTimeout(function(){
			t.play()
		},300)}),
	$("#mov9").on("inview",function(){
		var t=$("#mov9").get(0);setTimeout(function(){
			t.play()
		},300)});
});